...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkEmailStmt = $conn->prepare("SELECT email FROM login_register WHERE email = ?");
    ...
    if ($checkEmailStmt->num_rows > 0) {
        ...
        // Prepare and bind
        $stmt = $conn->prepare("INSERT INTO login_register (username, email, password) VALUES (?, ?, ?)");
    ...
    <div class="container p-5 d-flex flex-column align-items-center">
        ...
        <form method="post" class="form-control mt-5 p-4"
            ...
            <div class="mb-2 mt-4">
                ...
                color: navy;">I have an Account <a href="./landing.php"
